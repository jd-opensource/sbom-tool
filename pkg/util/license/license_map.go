...
// licenseMap is a map of license name to license ID.
var licenseNameKeys = map[string]string{
	...
	"Lesser Gnu Public License (LGPL), Version 2.1":            "LGPL-2.1",
	"GNU Library or Lesser General Public License (LGPL) V2.1": "LGPL-2.1",
	"The Unlicense":                                            "Unlicense",
	"Eclipse Public License 1.0":                               "EPL-1.0",
	"Eclipse Public License 2.0":                               "EPL-2.0",
	"Clause License Condition v1.0":                            "LicenseRef-scancode-commons-clause",
	...
	"GNU General Public License, Version 2 with the Classpath Exception":  "GPL-2.0",
	"Public Domain, per Creative Commons CC0":                             "CC0-1.0",
	"Apache License, Version 2.0; see: http://freemarker.org/LICENSE.txt": "Apache-2.0",
	"The New BSD License":                       "BSD-3-Clause",
	"BSD 3-clause License w/nuclear disclaimer": "BSD-3-Clause",
	"www.jcraft.com/jsch-agent-proxy/LICENSE":   "BSD-3-Clause",
}

// licenseLowercaseKeys is a map of lowercase license name to license ID.
var licenseLowercaseKeys = map[string]string{
